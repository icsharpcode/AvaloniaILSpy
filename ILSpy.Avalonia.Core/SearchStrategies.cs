...
namespace ICSharpCode.ILSpy
{
	abstract class AbstractSearchStrategy
	{
		...
		void Add<T>(Func<IEnumerable<T>> itemsGetter, TypeDefinition type, Language language, Action<SearchResult> addResult, Func<T, Language, bool> matcher, Func<T, IBitmap> image) where T : MemberReference
		{
